...
import { Invitation, Member, Product, SharedData, User, Vendor, type BreadcrumbItem } from '@/types';
import { Head, Link, usePage } from '@inertiajs/react';
import { PencilIcon, PlusIcon, SquarePen, Trash2 } from 'lucide-react';


export default function SellerInvitations() {
    const { vendor, invitations } = usePage<SharedData & { vendor: Vendor, invitations: Invitation[]}>().props;
    ...
    const breadcrumbs: BreadcrumbItem[] = [
      ...
      {
          title: 'Members',
          href: `/seller/${vendor.id}/invitations`,
      },
    ];
